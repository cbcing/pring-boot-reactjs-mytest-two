...
import com.example.daivd.react.React;
...
public class ProductController {
    ...
    public String products (@RequestParam(name = "sort", defaultValue = "name") String sortBy, Model model) throws JsonProcessingException, ScriptException {
